    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className={`px-3 py-1 rounded-full text-sm font-medium border capitalize ${getStatusColor(booking.status)}`}>
            {booking.status}
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="aspect-w-16 aspect-h-9">
              <img
                src={booking.property?.photos?.[0] || "https://via.placeholder.com/600x300?text=No+Image"}
